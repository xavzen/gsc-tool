...
#line 30 "H2.parser.ypp"
    ...
    #define YY_DECL H2::parser::symbol_type H2lex(yyscan_t yyscanner, std::uint32_t *pos)
...
#line 4469 "./H2/compiler_parser.hpp"
