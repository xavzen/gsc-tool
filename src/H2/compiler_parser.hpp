...
#line 33 "H2.parser.ypp"
    ...
    #define YY_DECL H2::parser::symbol_type H2lex(yyscan_t yyscanner, gsc::location& loc)
...
#line 4629 "./H2/compiler_parser.hpp"
