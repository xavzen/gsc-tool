...
private:
    ...
    void calc_local_vars_stmt(const gsc::context_ptr& ctx, const gsc::stmt_ptr& stmt);
    void calc_local_vars_stmt_list(const gsc::context_ptr& ctx, const gsc::stmt_list_ptr& stmt);
    ...
    static include_t include_maps_mp_utility_;
    static include_t include_common_scripts_utility_;
    static include_t include_common_scripts_createfx_;
