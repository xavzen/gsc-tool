...
#line 33 "IW7.parser.ypp"
    ...
    #define YY_DECL IW7::parser::symbol_type IW7lex(yyscan_t yyscanner, gsc::location& loc)
...
#line 4629 "./IW7/compiler_parser.hpp"
