...
#line 30 "S1.parser.ypp"

    #include <utils.hpp>
    typedef void *yyscan_t;
    #define YY_DECL S1::parser::symbol_type S1lex(yyscan_t yyscanner, std::uint32_t *pos)
...
switch (yykind)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_S1EOF ()
      {
        return symbol_type (token::S1EOF);
      }
#else
      static
      symbol_type
      ...
      make_S1error ()
      {
        return symbol_type (token::S1error);
      }
#else
      static
      symbol_type
      ...
      make_S1UNDEF ()
      {
        return symbol_type (token::S1UNDEF);
      }
#else
      static
      symbol_type
...
#line 4469 "./S1/compiler_parser.hpp"
