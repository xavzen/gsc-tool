...
enum class opcode : std::uint8_t
{
    ...
    OP_DecTop = 0x6A,
    OP_shift_left = 0x6B,
    OP_ScriptLocalMethodThreadCall = 0x6C,
    OP_ScriptLocalMethodChildThreadCall = 0x6D,
    OP_greater = 0x6E,
    OP_EvalLocalVariableCached0 = 0x6F,
    OP_EvalLocalVariableCached1 = 0x70,
    OP_EvalLocalVariableCached2 = 0x71,
    OP_EvalLocalVariableCached3 = 0x72,
    OP_EvalLocalVariableCached4 = 0x73,
    OP_EvalLocalVariableCached5 = 0x74,
    OP_EvalLocalVariableCached = 0x75,
    OP_SafeSetWaittillVariableFieldCached = 0x76,
    OP_jump = 0x77,
    OP_ScriptThreadCallPointer = 0x78,
    OP_GetZero = 0x79,
    OP_wait = 0x7A,
    OP_minus = 0x7B,
    OP_SetSelfFieldVariableField = 0x7C,
    OP_EvalNewLocalVariableRefCached0 = 0x7D,
    OP_multiply = 0x7E,
    OP_CreateLocalVariable = 0x7F,
    OP_ScriptLocalChildThreadCall = 0x80,
    OP_GetInteger = 0x81,
    OP_mod = 0x82,
    OP_EvalAnimFieldVariableRef = 0x83,
    OP_GetBuiltinFunction = 0x84,
    OP_GetGame = 0x85,
    OP_waittill = 0x86,
    OP_dec = 0x87,
    OP_EvalLocalVariableObjectCached = 0x88,
    OP_PreScriptCall = 0x89,
    OP_GetAnim = 0x8A,
    OP_GetUndefined = 0x8B,
    OP_EvalLevelFieldVariableRef = 0x8C,
    OP_GetAnimObject = 0x8D,
    OP_GetLevelObject = 0x8E,
    OP_bit_ex_or = 0x8F,
    OP_equality = 0x90,
    OP_ClearArray = 0x91,
    OP_jumpback = 0x92,
    ...
    OP_GetNegByte = 0x99,
    OP_GetBuiltinMethod = 0x9A,
    OP_CallBuiltinMethodPointer = 0x9B,
    OP_EvalArray = 0x9C,
    OP_vector = 0x9D,
    OP_ScriptFarMethodCall = 0x9E,
    OP_EvalLocalArrayCached = 0x9F,
    OP_GetByte = 0xA0,
    OP_ScriptChildThreadCallPointer = 0xA1,
    OP_bit_or = 0xA2,
    OP_AddArray = 0xA3,
    OP_waittillmatch2 = 0xA4,
    OP_waittillmatch = 0xA5,
    OP_GetLocalFunction = 0xA6,
    OP_GetNegUnsignedShort = 0xA7,
    OP_shift_right = 0xA8,
    OP_CallBuiltinMethod0 = 0xA9,
    OP_CallBuiltinMethod1 = 0xAA,
    OP_CallBuiltinMethod2 = 0xAB,
    OP_CallBuiltinMethod3 = 0xAC,
    OP_CallBuiltinMethod4 = 0xAD,
